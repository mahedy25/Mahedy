    ...
    <>
      ...
      <section className='relative h-screen flex md:flex-row flex-col-reverse items-center justify-center text-center md:text-start overflow-x-hidden z-10'>
        ...
        <div className='max-w-7xl mx-auto w-full z-10 px-6 lg:px-12'>
          ...
          >
            ...
            >
              Designing seamless interfaces with clean, efficient code.
            </h2>
          </div>
        </div>
      ...
      <div
        ...
        style={{
          clipPath: isHovered
            ...
            : 'circle(40px at var(--x, 50%) var(--y, 50%))',
      ...
      >
        <section className='relative bg-[#FDF6EC] h-screen flex md:flex-row flex-col-reverse items-center justify-center text-[#0F0F0F] text-center md:text-start overflow-x-hidden'>
          ...
          <div className='max-w-7xl mx-auto w-full z-10 px-6 lg:px-12'>
            <div>
              <h1 className='text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold leading-snug tracking-normal text-left z-10 mb-6 text-[#D90429]'>
                Frontend Developer <br /> Specialized in Next.js
              </h1>

              <h2 className='text-base sm:text-xl md:text-2xl lg:text-3xl font-semibold leading-relaxed tracking-normal text-left z-10 text-[#FF4D6D]'>
                Crafting engaging and user-centric digital experiences <br />{' '}
